...
$secret_key = '6LdzeFQdAAAAAFzvuLgRfRT7SrevoyIVItzKfCAv';
...
$nome_destinatario = "Curso de Enfermagem";

$email_destinatario = "cursoenfermagemnf@gmail.com";
$cc = "";
$bcc = "";
$name_reply = $nome;
$email_reply = $email;
...
if(email_locaweb($nome,$email,$nome_destinatario,$email_destinatario,$cc,$bcc,$name_reply, $email_reply ,$assunto, $mensagem_completa)==true){
     header("location: https://www.cursoenfermagem.com.br/?msg=enviado#contato");
}else{
    header("location: https://www.cursoenfermagem.com.br/?msg=erro#contato");
}
    }
    ...
    //retorno uma mensagem de erro. 
        ...
        header("location: https://www.cursoenfermagem.com.br/?msg=semvalidacao#contato");
